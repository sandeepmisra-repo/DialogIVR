 ...
 * Last generated by Orchestration Designer at: 2019-FEB-11  05:21:38 PM
 */
...
//		GoogleASR ASR=new GoogleASR();
		...
		//SSL Certificate
            ...
            String weburl = "https://texttospeech.googleapis.com/v1beta1/text:synthesize?key=AIzaSyAoLUXGkx3UPQ93T2ISL0X_QjZmEXFzmdI";
            String inputText =  mySession.getVariableField(IProjectVariables.OUT_NLPWS).toString();
...
//            String json = "{\"audioConfig\":{\"audioEncoding\":\"LINEAR16\",\"pitch\":0.00,\"speakingRate\":1.00},\"input\":{\"text\":\"\"},\"voice\":{\"languageCode\":\"en-US\",\"name\":\"en-US-Wavenet-D\"}}";
            String json = "{\"audioConfig\": {\"audioEncoding\": \"LINEAR16\",\"sampleRateHertz\":8000,\"effectsProfileId\":[\"telephony-class-application\"],\"pitch\": \"0.00\",\"speakingRate\": \"1.00\"},\"input\": {\"text\": \"\"},\"voice\": {\"languageCode\": \"en-US\",\"name\": \"en-US-Wavenet-E\"}}";
            ...
            String ttsOutFilePath="C:\\Program Files\\Apache Software Foundation\\Tomcat 8.5_Tomcat_test\\webapps\\decode\\"+ucid+"TTS"+count+".wav";
	...
	public java.util.Collection getBranches(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		aGoto = new com.avaya.sce.runtime.Goto("TTSErrorCheck", 0, true, "Default");
		list.add(aGoto);
