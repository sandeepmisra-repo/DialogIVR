 ...
 * Last generated by Orchestration Designer at: 2019-FEB-11  04:53:46 PM
 */
public class Record extends com.avaya.sce.runtime.Form {
	...
	public com.avaya.sce.runtime.Submit getSubmit(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		submit = new com.avaya.sce.runtime.Submit("RecordDataAssign");
		return submit;
	}
	/**
	...
	public com.avaya.sce.runtime.Record getRecord(com.avaya.sce.runtimecommon.SCESession mySession) {
		...
		record = new com.avaya.sce.runtime.Record("WelcomeRecord", true, "30s", true, "2s", false, com.avaya.sce.runtime.Record.WAV_TYPE, com.avaya.sce.runtime.Record.RECORDMODE_AUDIO, promptNames, grammarInfo, events);
		return record;
	}
	/**
