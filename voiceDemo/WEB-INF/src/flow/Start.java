 ...
 * code generator.<br>
 * Last generated by Orchestration Designer at: 2019-FEB-11  04:47:49 PM
 */
public class Start extends com.avaya.sce.runtime.Entry {
	 ...
	 * Last generated by Orchestration Designer at: 2019-AUG-28  10:13:08 AM
	...
	public void initializeVariables(com.avaya.sce.runtimecommon.SCESession session) {
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.OUT_GOOGLE_ASR, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.ASRERROR_COUNT, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.OUT_GOOGLE_TTS, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.STT_TIME, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SERVER_STATUS_TTS, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SERVER_STATUS_NLPWS, "", null, session, false, false );
		session.putVariable(variable);
		...
		variableFields = new String[] {
			IProjectVariables.WELCOME_RECORD_FIELD_CONFIDENCE,
			IProjectVariables.WELCOME_RECORD_FIELD_DURATION,
			IProjectVariables.WELCOME_RECORD_FIELD_MAXTIME,
			IProjectVariables.WELCOME_RECORD_FIELD_SIZE,
			IProjectVariables.WELCOME_RECORD_FIELD_TERMCHAR,
			IProjectVariables.WELCOME_RECORD_FIELD_UTTERANCE,
			IProjectVariables.WELCOME_RECORD_FIELD_VALUE };
		variable = com.avaya.sce.runtime.ComplexVariable.createComplexVariable(IProjectVariables.WELCOME_RECORD, variableFields, null, session, false, false );
		session.putVariable(variable);
		...
		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.URL, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.SERVER_STATUS_ASR, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.APPLICATION__EXIT, "no", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.OUT_NLPWS, "", null, session, false, false );
		session.putVariable(variable);

		variable = com.avaya.sce.runtime.SimpleVariable.createSimpleVariable(IProjectVariables.FILE_NAME, "", null, session, false, false );
		session.putVariable(variable);
